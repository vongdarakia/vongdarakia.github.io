...
export type CreatePages_MarkdownQueryVariables = Exact<{ [key: string]: never; }>;


export type CreatePages_MarkdownQuery = { allMarkdownRemark: { edges: Array<{ node: (
...
export type AuthorQuery = { site?: Maybe<{ siteMetadata?: Maybe<{ author?: Maybe<Pick<SiteSiteMetadataAuthor, 'firstName'>> }> }> };
